...
const AdminHeader = ({ breadcrumbs = [] }) => {
  return (
    <header className="flex h-16 shrink-0 items-center gap-2 border-b border-outline-variant/20 pr-6 pl-0 backdrop-blur-md sticky top-0 z-30 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
