  ...
  const handleReset = async () => {
    ...
    if (!apiError) {
      Alert.alert(
        ...
        [{ text: "Go to Login", onPress: () => router.replace('/(login)/login') }]
      );
    } else {
      setError(apiError);
    }
          ...
          >
            ...
            <View style={{ gap: 12, marginBottom: 20 }}>
              ...
              <View style={{ 
                ...
                <MaterialIcons name="lock" size={20} color={isFocused ? "#c13584" : "#52525b"} style={{ marginRight: 12, marginTop: 20 }} />
                <TextInput
                ...
                />
                <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={{ marginTop: 20 }}>
                  <MaterialIcons name={showPassword ? "visibility" : "visibility-off"} size={20} color="#52525b" />
                </TouchableOpacity>
              </View>
            ...
            <View style={{ gap: 12, marginBottom: 32 }}>
              <Text style={{ fontSize: 12, fontWeight: 'bold', tracking: 1.2, color: '#a48a93', marginLeft: 16 }}>CONFIRM PASSWORD</Text>
              <View style={{ 
                flexDirection: 'row', 
                items: 'center', 
                borderRadius: 32, 
                backgroundColor: '#1e2020', 
                borderWidth: 2, 
                borderColor: isConfirmFocused ? '#c13584' : 'transparent',
                paddingHorizontal: 20,
                height: 64
              }}>
                <MaterialIcons name="lock" size={20} color={isConfirmFocused ? "#c13584" : "#52525b"} style={{ marginRight: 12, marginTop: 20 }} />
                <TextInput
                  style={{ flex: 1, color: 'white', fontSize: 16 }}
                  placeholder="••••••••"
                  placeholderTextColor="#52525b"
